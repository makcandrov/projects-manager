...
public class ProjectPanel {
	...
	public static JPanel getPanel(MainFrame frame, int persID) {
		...
		ResultArray userInfos = db.getPersonneInfos(persID);
		...
		JLabel nomLabel = new JLabel(String.format("<html><div %s> %s </span><span %s> %s </span></div></html>", nomStyle, nom.toUpperCase(), prenomStyle, prenom));
		...
		ImageIcon refreshIconD =  new ImageIcon(new ImageIcon("img/icone_refresh.png").getImage().getScaledInstance(26, 26, Image.SCALE_SMOOTH));
		ImageIcon refreshIconH =  new ImageIcon(new ImageIcon("img/icone_refresh_hover.png").getImage().getScaledInstance(26, 26, Image.SCALE_SMOOTH));
		...
		String ongoingProjectsS = String.format("<html><span %s>MES PROJETS EN COURS (%d)</span></html>", ongoingProjectsStyle, myOngoingProjetcs.size);
		...
		String waitingProjectsS = String.format("<html><span %s>MES PROJETS EN ATTENTE (%d)</span></html>", waitingProjectsStyle, myWaitingProjetcs.size);
     ...
     // MES PROJETS ARCHIVES ------------
		...
		String endedProjectsS = String.format("<html><span %s>MES PROJETS ARCHIVÉS (%d)</span></html>", endedProjectsStyle, myEndedProjetcs.size);
		...
		JScrollPane p1jsp = (new JScrollPane(p1, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED));
		...
		String otherOngoingProjectsS = String.format("<html><span %s>AUTRES PROJETS EN COURS (%d)</span></html>", otherOngoingProjectsStyle, otherOngoingProjects.size);
		...
		String otherEndedProjectsS = String.format("<html><span %s>AUTRES PROJETS ARCHIVÉS (%d)</span></html>", otherEndedProjectsStyle, otherEndedProjects.size);
		...
		JScrollPane p2jsp = (new JScrollPane(p2, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED));
		...
		String titleNvProjetS = String.format("<html><span %s>CRÉER UN NOUVEAU PROJET</span></html>", titleNvProjetStyle);
		...
		ImageIcon creerProjetIconD = new ImageIcon(new ImageIcon("img/icone_new_project.png").getImage().getScaledInstance(18, 18, Image.SCALE_SMOOTH));
	    ImageIcon creerProjetIconH = new ImageIcon(new ImageIcon("img/icone_new_project_hover.png").getImage().getScaledInstance(18, 18, Image.SCALE_SMOOTH));
        ...
        JScrollPane p3jsp = (new JScrollPane(p3, JScrollPane.VERTICAL_SCROLLBAR_NEVER, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER));
		p3scroll.add(p3jsp);
		
        
		tabPanel.setBorder(BorderFactory.createEmptyBorder(15, 0, 0, 0));
		tabPanel.add("<html><span style='font-size:11px; font-weight:bold; font-family:Optima'>Mes projets</span></html>", p1scroll);
		tabPanel.add("<html><span style='font-size:11px; font-weight:bold; font-family:Optima'>Autres projets</span></html>", p2scroll);
		tabPanel.add("<html><span style='font-size:11px; font-weight:normal; font-family:Optima; font-style:italic'>Créer un projet</span></html>", p3scroll);
	...
	private static JPanel getAnOngoingProjectPanel(HashMap<String, Object> ongoingProject) {
		...
		ResultArray lastActivityPersInfos = db.getPersonneInfos(lastActivityPersId);
		...
		if (myLastActivityMission.equals("_NEW_")) {
			myLastActivityS = String.format("<html><span %s>Votre dernière activité</span> <br><br> &nbsp; <span %s>Le %s</span><br> &nbsp; <span %s>A rejoint le projet</span></html>", subtitleStyle, dateStyle, myLastActivityDate, sessionWorkTimeStyle);
		} else if (myLastActivityMission.equals("_END_")) {
			myLastActivityS = String.format("<html><span %s>Votre dernière activité</span> <br><br> &nbsp; <span %s>Le %s</span><br> &nbsp; <span %s>A terminé le projet</span></html>", subtitleStyle, dateStyle, myLastActivityDate, sessionWorkTimeStyle);
		} else {
			myLastActivityS = String.format("<html><span %s>Votre dernière activité</span> <br><br> &nbsp; <span %s>Le %s</span><br> &nbsp; <span %s> %s </span><span %s> - %s</span></html>", subtitleStyle, dateStyle, myLastActivityDate, missionStyle, myLastActivityMission, sessionWorkTimeStyle, myLastActivityWorkTime);
		}
		
		String lastActivityS;
		if (lastActivityMission.equals("_NEW_")) {
			lastActivityS = String.format("<html><span %s>Activité la plus récente</span><br><br> &nbsp; <span %s>Le %s</span><br> &nbsp; <span %s>Par %s %s</span><br> &nbsp; <span %s>A rejoint le projet</span></html>",subtitleStyle, dateStyle, lastActivityDate, personneStyle, lastActivityNom.toUpperCase(), lastActivityPrenom, sessionWorkTimeStyle);
		} else if (lastActivityMission.equals("_END_")) {
			lastActivityS = String.format("<html><span %s>Activité la plus récente</span><br><br> &nbsp; <span %s>Le %s</span><br> &nbsp; <span %s>Par %s %s</span><br> &nbsp; <span %s>A terminé le projet</span></html>",subtitleStyle, dateStyle, lastActivityDate, personneStyle, lastActivityNom.toUpperCase(), lastActivityPrenom, sessionWorkTimeStyle);
		} else if (lastActivityMission.equals("_QUIT_")) {
			lastActivityS = String.format("<html><span %s>Activité la plus récente</span><br><br> &nbsp; <span %s>Le %s</span><br> &nbsp; <span %s>Par %s %s</span><br> &nbsp; <span %s>A quitté le projet</span></html>",subtitleStyle, dateStyle, lastActivityDate, personneStyle, lastActivityNom.toUpperCase(), lastActivityPrenom, sessionWorkTimeStyle);
		} else {
			lastActivityS = String.format("<html><span %s>Activité la plus récente</span><br><br> &nbsp; <span %s>Le %s</span><br> &nbsp; <span %s>Par %s %s</span><br> &nbsp; <span %s> %s </span><span %s> - %s </span></html>",subtitleStyle, dateStyle, lastActivityDate, personneStyle, lastActivityNom.toUpperCase(), lastActivityPrenom, missionStyle, lastActivityMission, sessionWorkTimeStyle, lastActivityWorkTime);
		}
		
		String myWorkTimeS = String.format("<html><span %s>Votre temps de travail</span><br>&nbsp; %s </html>", subtitleStyle, myWorkTime);
		String workTimeS = String.format("<html><span %s>Temps de travail de l'équipe</span><br> &nbsp; %s </html>", subtitleStyle, totalWorkTime);
		
		ImageIcon myWorkTimeIcon = new ImageIcon(new ImageIcon("img/icone_my_worktime.png").getImage().getScaledInstance(28, 28, Image.SCALE_SMOOTH));
		ImageIcon workTimeIcon = new ImageIcon(new ImageIcon("img/icone_total_worktime.png").getImage().getScaledInstance(28, 28, Image.SCALE_SMOOTH));
		...
		ImageIcon addSessionIconD = new ImageIcon(new ImageIcon("img/icone_add_activity.png").getImage().getScaledInstance(26, 26, Image.SCALE_SMOOTH));
		ImageIcon addSessionIconH = new ImageIcon(new ImageIcon("img/icone_add_activity_hover.png").getImage().getScaledInstance(26, 26, Image.SCALE_SMOOTH));
		...
		addSessionBtn.setName(String.format("projectPanel/myProjects/addSession?projectID=%s&persID=%s", projectID, persID));
		addSessionBtn.addActionListener(frame);
		
		ImageIcon historicIconD = new ImageIcon(new ImageIcon("img/icone_historique_sessions.png").getImage().getScaledInstance(26, 26, Image.SCALE_SMOOTH));
		ImageIcon historicIconH = new ImageIcon(new ImageIcon("img/icone_historique_sessions_hover.png").getImage().getScaledInstance(26, 26, Image.SCALE_SMOOTH));
		...
		historicBtn.setName(String.format("projectPanel/myProjects/historic?projectID=%s&persID=%s", projectID, persID));
		historicBtn.addActionListener(frame);
		
		ImageIcon projectOverviewIconD = new ImageIcon(new ImageIcon("img/icone_project_overview.png").getImage().getScaledInstance(26, 26, Image.SCALE_SMOOTH));
		ImageIcon projectOverviewIconH = new ImageIcon(new ImageIcon("img/icone_project_overview_hover.png").getImage().getScaledInstance(26, 26, Image.SCALE_SMOOTH));
		...
		projectOverviewBtn.setName(String.format("projectPanel/myProjects/stats?projectID=%s&persID=%s", projectID, persID));
		...
		leaveProjectBtn.setToolTipText("<html>Vous ne pouvez pas quitter un projet dans lequel vous avez du temps de travail.</html>");
		leaveProjectBtn.setMultipleText(leaveProjectSD, leaveProjectSH, null);
		leaveProjectBtn.setMultipleInnerColor(leaveProjectBtn.getDefaultInnerColor(), new Color(255, 89, 89), new Color(222, 38, 38));
		leaveProjectBtn.setMultipleBorderColor(leaveProjectBtn.getDefaultBorderColor(), new Color(222, 38, 38), new Color(255, 89, 89));
		leaveProjectBtn.setName(String.format("projectPanel/myProjects/leaveProject?projectID=%s&persID=%s", projectID, persID));
		...
		String finishProjectSD = String.format("<html><span %s>Projet terminé (%d/%d)</span></html>", finishProjectStyleD, nbWaitingParticipants, nbParticipants);
		String finishProjectSH = String.format("<html><span %s>Projet terminé (%d/%d)</span></html>", finishProjectStyleH, nbWaitingParticipants, nbParticipants);
		JRoundedButton finishProjectBtn = new JRoundedButton();
		finishProjectBtn.setToolTipText("<html>Ce projet n'apparaîtra plus dans vos projets en cours.<br>Tous les membres du projet doivent indiquer qu'ils ont terminé pour que celui-ci soit archivé.</html>");
		finishProjectBtn.setMultipleText(finishProjectSD, finishProjectSH, null);
		finishProjectBtn.setMultipleInnerColor(finishProjectBtn.getDefaultInnerColor(), new Color(255, 229, 39), new Color(222, 199, 34));
		finishProjectBtn.setMultipleBorderColor(finishProjectBtn.getDefaultBorderColor(), new Color(222, 199, 34), new Color(255, 229, 39));
		finishProjectBtn.setName(String.format("projectPanel/myProjects/finishProject?projectID=%s&persID=%s", projectID, persID));
	...
	private static JPanel getAWaitingProjectPanel(HashMap<String, Object> ongoingProject) {
		...
		String leaveProjectSH = String.format("<html><span %s>Quitter le projet</span></html>", leaveProjectStyleH);
		JRoundedButton leaveProjectBtn = new JRoundedButton();
		leaveProjectBtn.setToolTipText("<html>Vous devrez attendre une semaine pour rejoindre de nouveau ce projet.<br>Vous ne pouvez pas quitter un projet dans lequel vous avez du temps de travail.</html>");
		leaveProjectBtn.setMultipleText(leaveProjectSD, leaveProjectSH, null);
		leaveProjectBtn.setMultipleInnerColor(leaveProjectBtn.getDefaultInnerColor(), new Color(255, 89, 89), new Color(222, 38, 38));
		leaveProjectBtn.setMultipleBorderColor(leaveProjectBtn.getDefaultBorderColor(), new Color(222, 38, 38), new Color(255, 89, 89));
		leaveProjectBtn.setName(String.format("projectPanel/myProjects/leaveProject?projectID=%s&persID=%s", projectID, persID));
		...
		String fresumeProjectSD = String.format("<html><span %s>Reprendre le projet (%d/%d)</span></html>", resumeProjectStyleD, nbWaitingParticipants, nbParticipants);
		String resumeProjectSH = String.format("<html><span %s>Reprendre le projet (%d/%d)</span></html>", resumeProjectStyleH, nbWaitingParticipants, nbParticipants);
		JRoundedButton resumeProjectBtn = new JRoundedButton();
		resumeProjectBtn.setToolTipText("<html>Ce projet réapparaîtra dans vos projets en cours.<br>Tous les membres du projet doivent indiquer qu'ils ont terminé pour que celui-ci soit archivé.</html>");
		resumeProjectBtn.setMultipleText(fresumeProjectSD, resumeProjectSH, null);
		resumeProjectBtn.setMultipleInnerColor(resumeProjectBtn.getDefaultInnerColor(), new Color(255, 229, 39), new Color(222, 199, 34));
		resumeProjectBtn.setMultipleBorderColor(resumeProjectBtn.getDefaultBorderColor(), new Color(222, 199, 34), new Color(255, 229, 39));
		resumeProjectBtn.setName(String.format("projectPanel/myProjects/resumeProject?projectID=%s&persID=%s", projectID, persID));
	...
	private static JPanel getAnEndedProjectPanel(HashMap<String, Object> endedProject) {
		...
		String dateProjectS = String.format("<html><div %s>Débuté le %s<br>Terminé le %s</div></html>", dateProjectStyle, dateDebut, dateFin);
		...
		String resumeProjectStyleD = "style='font-size:9px; font-weight:normal; font-style:italic; font-family:Optima'";
		String resumeProjectStyleH = "style='font-size:9px; font-weight:normal; font-style:italic; font-family:Optima'";
		String fresumeProjectSD = String.format("<html><span %s>Reprendre le projet</span></html>", resumeProjectStyleD);
		String resumeProjectSH = String.format("<html><span %s>Reprendre le projet</span></html>", resumeProjectStyleH);
		JRoundedButton resumeProjectBtn = new JRoundedButton();
		resumeProjectBtn.setToolTipText("<html>Tout le monde a terminé ce projet.<br>Si vous reprenez ce projet, il apparaîtra en attente pour tous les participants.</html>");
		resumeProjectBtn.setMultipleText(fresumeProjectSD, resumeProjectSH, null);
		resumeProjectBtn.setMultipleInnerColor(resumeProjectBtn.getDefaultInnerColor(), new Color(255, 229, 39), new Color(222, 199, 34));
		resumeProjectBtn.setMultipleBorderColor(resumeProjectBtn.getDefaultBorderColor(), new Color(222, 199, 34), new Color(255, 229, 39));
		resumeProjectBtn.setName(String.format("projectPanel/myProjects/resumeArchivedProject?projectID=%s&persID=%s", projectID, persID));
		resumeProjectBtn.addActionListener(frame);
	...
	private static JPanel getOtherOngoingPanel(HashMap<String, Object> ongoingProject) {
		...
		for (int j = 0; j < participants.size; j++) {
			nomsParticipantsS += String.format("&nbsp; %s %s<br>", ((String) participants.get(j,  "nom")).toUpperCase(), (String) participants.get(j, "prenom"));
		}
		
		String nomsParticipantsStyle = "style='font-weight:normal; font-size:9px'";
		String participantsS = String.format("<html><span %s> %s </span><br><span %s> %s </span></html>" , subtitleStyle, nbParticipantsS, nomsParticipantsStyle, nomsParticipantsS);
		
		ImageIcon participantsIcon = new ImageIcon(new ImageIcon("img/icone_teamworkers.png").getImage().getScaledInstance(28, 28, Image.SCALE_SMOOTH));
		...
		ImageIcon takePartIconD = new ImageIcon(new ImageIcon("img/icone_take_part.png").getImage().getScaledInstance(26, 26, Image.SCALE_SMOOTH));
		ImageIcon takePartIconH = new ImageIcon(new ImageIcon("img/icone_take_part_hover.png").getImage().getScaledInstance(26, 26, Image.SCALE_SMOOTH));
		...
		takePartBtn.setName(String.format("projectPanel/otherProjects/takePartBtn?projectID=%s&persID=%s", projectID, persID));
