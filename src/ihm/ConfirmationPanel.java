...
public class ConfirmationPanel {
	...
	public static JPanel getPanel(ConfirmationDialog frame, String text) {
		...
		annulerBtn.setMultipleInnerColor(validerBtn.getDefaultInnerColor(), new Color(255, 89, 89), new Color(222, 38, 38));
		annulerBtn.setMultipleBorderColor(validerBtn.getDefaultBorderColor(), new Color(222, 38, 38), new Color(255, 89, 89));
