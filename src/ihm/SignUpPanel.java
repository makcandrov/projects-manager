...
public class SignUpPanel {
	...
	public static JPanel getPanel(ActionListener frame) {
		...
		annulerBtn.setMultipleInnerColor(annulerBtn.getDefaultInnerColor(), new Color(255, 89, 89), new Color(222, 38, 38));
		annulerBtn.setMultipleBorderColor(annulerBtn.getDefaultBorderColor(), new Color(222, 38, 38), new Color(255, 89, 89));
