...
public class NewWorkSessionPanel {
	...
	public static JPanel getPanel(MainFrame frame, int projectID, int persID) {
		...
		validerBtn.setMultipleInnerColor(validerBtn.getDefaultInnerColor(), new Color(71, 255, 134), new Color(19, 203, 82));
		validerBtn.setMultipleBorderColor(validerBtn.getDefaultBorderColor(), new Color(19, 203, 82), new Color(71, 255, 134));
